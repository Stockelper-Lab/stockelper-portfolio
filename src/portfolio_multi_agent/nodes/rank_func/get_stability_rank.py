...
async def get_stability_rank(
    ...
    Returns:
        안정성 분석 순위 상위 N개 종목 정보 리스트 [{"code": "종목코드", "name": "종목명"}, ...]
    """
    _app_key = app_key
    ...
    url = f"{base_url}/uapi/domestic-stock/v1/ranking/finance-ratio"
    headers = {
    ...
    params = {
        ...
        "fid_rank_sort_cls_code": "11",  # 안정성 분석
        "fid_blng_cls_code": "0",
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print(f"안정성 분석 순위 Top {len(stock_codes)} 종목 코드")
    print("=" * 80)
    print(stock_codes)
