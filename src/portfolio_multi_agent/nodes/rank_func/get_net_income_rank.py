...
async def get_net_income_rank(
    ...
    Returns:
        당기순이익 순위 상위 N개 종목 정보 리스트 [{"code": "종목코드", "name": "종목명"}, ...]
    """
    _app_key = app_key
    ...
    params = {
        ...
        "fid_rank_sort_cls_code": "3",  # 당기순이익
        "fid_blng_cls_code": "0",
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print(f"당기순이익 순위 Top {len(stock_codes)} 종목 코드")
    print("=" * 80)
    print(stock_codes)
