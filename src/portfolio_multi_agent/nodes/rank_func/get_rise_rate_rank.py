...
async def get_rise_rate_rank(
    ...
    Returns:
        상승률 순위 상위 N개 종목 정보 리스트 [{"code": "종목코드", "name": "종목명"}, ...]
    """
    _app_key = app_key
...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print(f"상승률 순위 Top {len(stock_codes)} 종목 코드")
    print("=" * 80)
    print(stock_codes)
